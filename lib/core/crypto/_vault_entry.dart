...
class VaultEntry {
  ...
  VaultEntry withFavorite(bool value) => VaultEntry._metadata(this, value, deletedAt);

  VaultEntry inTrash(int? timestamp) => VaultEntry._metadata(this, isFavorite, timestamp);
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (isFavorite) _VaultEntryJson.favorite: true,
    if (deletedAt != null) _VaultEntryJson.deletedAt: deletedAt,
  };
  ...
  static VaultEntry fromJson(
    ...
    if (value is Map<String, dynamic> &&
      ...
      final favorite = value.containsKey(_VaultEntryJson.favorite) ? value[_VaultEntryJson.favorite] : false;
      final deletedAt = value[_VaultEntryJson.deletedAt];
      if (favorite is bool &&
          (deletedAt == null || (deletedAt is int && deletedAt >= 0 && deletedAt <= 8640000000000000))) {
        final contents = Map<String, dynamic>.of(value)
          ..remove(_VaultEntryJson.favorite)
          ..remove(_VaultEntryJson.deletedAt);
        return fromJson(
          contents,
          legacy: legacy,
          files: files,
          ...
          metadata: false,
        ).withFavorite(favorite).inTrash(deletedAt as int?);
      }
